...
$mail->Port = 587;  
   ...
   $user_check10 = "SELECT * from registration_sellers where(verification_status ='1' or  verification_by_call = '1') and  sales_id='SAL_000019'";
   ...
   $run10=mysqli_query($db,$user_check10);
 ...
 // $mail->addBCC('siddharth@goolean.tech');
  ...
  $mail-> Subject= 'Hawker list';
    $mail-> Body="<table align=left cellpadding=3 cellspacing=0 border=1>
       ...
       <tr><td><b>Total Hawker add by Harpreet : </b></td><td>".$count10."</td></tr>
       </table>";
