...
{    
 ...
 ////////IMAGE URL fixer//////////
    ...
    /*  print_r("SELECT name,user_type,shop_latitude,shop_longitude,shop_gps_id,mobile_no_contact,business_mobile_no,hawker_code,menu_image,menu_image_2,menu_image_3,menu_image_4,seasonal_temp_hawker_type from registration_sellers where cat_id in ($array) and city='".$city."' and user_type='Fix' and duty_status='1' order by id DESC");
      die();*/
//SELECT * FROM registration_sellers WHERE LOCATE(CONCAT(',', 41 ,','),CONCAT(',',cat_id,',')) > 0
    // cat_id in ($array)
    //  $q=$this->db->query("SELECT business_name as name,user_type,shop_latitude,shop_longitude,shop_gps_id,mobile_no_contact,business_mobile_no,hawker_code,menu_image,menu_image_2,menu_image_3,menu_image_4,seasonal_temp_hawker_type from registration_sellers where LOCATE(CONCAT(',', $array ,','),CONCAT(',',cat_id,',')) and city='".$city."' and user_type='Fix' and duty_status='1' order by id DESC");
     $q=$this->db->query("SELECT business_name as name,user_type,shop_latitude,shop_longitude,shop_gps_id,mobile_no_contact,business_mobile_no,hawker_code,menu_image,menu_image_2,menu_image_3,menu_image_4,seasonal_temp_hawker_type from registration_sellers where cat_id in ($array) and city='".$city."' and user_type='Fix' and duty_status='1' order by id DESC");
    ...
    {  
//echo "SELECT name,user_type,shop_latitude,shop_longitude,shop_gps_id,mobile_no_contact,business_mobile_no,hawker_code,menu_image,menu_image_2,menu_image_3,menu_image_4,seasonal_temp_hawker_type from registration_sellers where cat_id in ($array) and city='".$city."' and user_type='Temporary' and  seasonal_temp_hawker_type='Fix' and duty_status='1' order by id DESC";exit;
    //  $q=$this->db->query("SELECT business_name as name,user_type,shop_latitude,shop_longitude,shop_gps_id,mobile_no_contact,business_mobile_no,hawker_code,menu_image,menu_image_2,menu_image_3,menu_image_4,seasonal_temp_hawker_type from registration_sellers where  LOCATE(CONCAT(',', $array ,','),CONCAT(',',cat_id,',')) and city='".$city."' and user_type='Temporary' and  seasonal_temp_hawker_type='Fix' and duty_status='1' order by id DESC");
    	$q=$this->db->query("SELECT business_name as name,user_type,shop_latitude,shop_longitude,shop_gps_id,mobile_no_contact,business_mobile_no,hawker_code,menu_image,menu_image_2,menu_image_3,menu_image_4,seasonal_temp_hawker_type from registration_sellers where cat_id in ($array) and city='".$city."' and user_type='Temporary' and  seasonal_temp_hawker_type='Fix' and duty_status='1' order by id DESC");
       return($q->result_array());
    }
       function check_data_by_registerseller_seasonal_fix($array,$city)
    {  
     // $q=$this->db->query("SELECT business_name as name,user_type,shop_latitude,shop_longitude,shop_gps_id,mobile_no_contact,business_mobile_no,hawker_code,menu_image,menu_image_2,menu_image_3,menu_image_4,seasonal_temp_hawker_type from registration_sellers where LOCATE(CONCAT(',', $array ,','),CONCAT(',',cat_id,',')) and city='".$city."' and user_type='Seasonal' and  seasonal_temp_hawker_type='Fix' and duty_status='1' order by id DESC");
    ...
    {  
     // $q=$this->db->query("SELECT business_name as name,user_type,shop_latitude,shop_longitude,shop_gps_id,mobile_no_contact,business_mobile_no,hawker_code,menu_image,menu_image_2,menu_image_3,menu_image_4,seasonal_temp_hawker_type from registration_sellers where LOCATE(CONCAT(',', $array ,','),CONCAT(',',cat_id,',')) and city='".$city."' and user_type='Seasonal' and  seasonal_temp_hawker_type='Moving' and duty_status='1' order by id DESC");
...
// $q=$this->db->query("SELECT business_name as name,user_type,shop_latitude,shop_longitude,shop_gps_id,mobile_no_contact,business_mobile_no,hawker_code,menu_image,menu_image_2,menu_image_3,menu_image_4,seasonal_temp_hawker_type from registration_sellers where LOCATE(CONCAT(',', $array ,','),CONCAT(',',sub_cat_id,',')) and city='".$city."' and user_type='Fix' and duty_status='1' order by id DESC");
       //return($q->result_array()); 
    ...
    {  
     //echo "SELECT name,user_type,shop_latitude,shop_longitude,shop_gps_id,mobile_no_contact,business_mobile_no,hawker_code,menu_image,menu_image_2,menu_image_3,menu_image_4,seasonal_temp_hawker_type from registration_sellers where sub_cat_id IN ($array) and city='".$city."'and user_type='Temporary' and  seasonal_temp_hawker_type='Fix'  and duty_status='1' order by id DESC";exit;
      //$q=$this->db->query("SELECT business_name as name,user_type,shop_latitude,shop_longitude,shop_gps_id,mobile_no_contact,business_mobile_no,hawker_code,menu_image,menu_image_2,menu_image_3,menu_image_4,seasonal_temp_hawker_type from registration_sellers where LOCATE(CONCAT(',', $array ,','),CONCAT(',',sub_cat_id,',')) and city='".$city."'and user_type='Temporary' and  seasonal_temp_hawker_type='Fix'  and duty_status='1' order by id DESC");
      $q=$this->db->query("SELECT business_name as name,user_type,shop_latitude,shop_longitude,shop_gps_id,mobile_no_contact,business_mobile_no,hawker_code,menu_image,menu_image_2,menu_image_3,menu_image_4,seasonal_temp_hawker_type from registration_sellers where sub_cat_id IN ($array) and city='".$city."'and user_type='Temporary' and  seasonal_temp_hawker_type='Fix'  and duty_status='1' order by id DESC");
       return($q->result_array());
    }
     function check_data_by_registerseller1_seasonal_fix($array,$city)
    {  
     // $q=$this->db->query("SELECT business_name as name,user_type,shop_latitude,shop_longitude,shop_gps_id,mobile_no_contact,business_mobile_no,hawker_code,menu_image,menu_image_2,menu_image_3,menu_image_4,seasonal_temp_hawker_type from registration_sellers  where LOCATE(CONCAT(',', $array ,','),CONCAT(',',sub_cat_id,',')) and city='".$city."'and user_type='Seasonal' and  seasonal_temp_hawker_type='Fix'  and duty_status='1' order by id DESC");
    ...
    {  
      //$q=$this->db->query("SELECT business_name as name,user_type,shop_latitude,shop_longitude,shop_gps_id,mobile_no_contact,business_mobile_no,hawker_code,menu_image,menu_image_2,menu_image_3,menu_image_4,seasonal_temp_hawker_type from registration_sellers where LOCATE(CONCAT(',', $array ,','),CONCAT(',',sub_cat_id,',')) and city='".$city."'and user_type='Seasonal' and  seasonal_temp_hawker_type='Moving'  and duty_status='1' order by id DESC");
  ...
  function check_data_by_registerseller1_temp_moving($array,$city)
    ...
    {  
      //$q=$this->db->query("SELECT business_name as name,user_type,shop_latitude,shop_longitude,shop_gps_id,mobile_no_contact,business_mobile_no,hawker_code,menu_image,menu_image_2,menu_image_3,menu_image_4,seasonal_temp_hawker_type from registration_sellers  where LOCATE(CONCAT(',', $array ,','),CONCAT(',',cat_id,','))  and city='".$city."' and user_type='Moving' and duty_status='1' order by id DESC");
    ...
    {  
     // $q=$this->db->query("SELECT business_name as name,user_type,shop_latitude,shop_longitude,shop_gps_id,mobile_no_contact,business_mobile_no,hawker_code,menu_image,menu_image_2,menu_image_3,menu_image_4,seasonal_temp_hawker_type from registration_sellers where LOCATE(CONCAT(',', $array ,','),CONCAT(',',sub_cat_id,',')) and city='".$city."' and user_type='Moving' and duty_status='1' order by id DESC");
       ...
       return($q->result_array());
      /*  print_r("SELECT business_name as name,user_type,shop_latitude,shop_longitude,shop_gps_id,mobile_no_contact,business_mobile_no,hawker_code from registration_sellers where FIND_IN_SET('".$sub_cat_id."', sub_cat_id) and city='".$city."' and user_type='Moving'");
       die();*/
...
public function getParameter()
 ...
 public function getBannerCategory()
    {
      $this->db->select('cat_name,cat_icon_image,type,id');
