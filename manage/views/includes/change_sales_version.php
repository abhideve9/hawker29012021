...
$adminName=$_SESSION['adminName'];
  if(isset($_REQUEST['submit']))
  {
    ...
    $updateQuery="UPDATE check_version_for_sale SET version_name='$version_name',version_code='$version_code',status='1',modified_date='$now',modified_user_name='$adminName',admin_status='1'";
    $updateResult=mysqli_query($db,$updateQuery);
    if($updateResult)
    {
     ?>
      <script>
        alert("Sales Version  update Successfully");
          location.href="version.php?action=showsales_version";
      </script>
    <?php       
    }
    else{
...
<div class="vd_title-section clearfix">
  ...
  <?php
  $userQuery="SELECT version_name,version_code FROM check_version_for_sale";
