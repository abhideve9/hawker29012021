...
//exit();
  if(isset($_REQUEST['id']))
  {
    ...
    //$message=$_REQUEST['message'];
      ...
      $UpdateQuery="UPDATE ads_plans SET status='1',modified_date='$now', admin_id='$adminid', admin_name='$adminName' WHERE id='".$_REQUEST['id']."'";
      $UpdateResult=mysqli_query($db,$UpdateQuery);
      if($UpdateResult)
      {
         ?>
        <script>
          alert("Ads Plan Activate successfully");
