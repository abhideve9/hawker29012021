  ...
  <!-- page content -->
       <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Expired Paid Advertisement </h2>
        ...
        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap " cellspacing="0" width="100%">
                      ...
                      <tbody>
                       <?php 
                $getUsers="SELECT * FROM paid_advertisement_by_merchant where payment_status='Paid' AND ads_status='Expired' AND aproval_status='1'";
