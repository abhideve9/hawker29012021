...
<link href="bootstrap3.css" rel="stylesheet">  
  <!-- page content -->
       <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Free Advertisement <b>(Pending For Approval)</b></h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                      ...
                      <tbody>
                          <?php 
                          $getUsers="SELECT * FROM tbl_request_for_hawker_advertisement where aproval_status='0' AND rejection_status='0' AND status='1'";
                      ...
                      <td><a class="example-image-link" href="data:image/png;base64, <?php echo $image_2; ?>" data-lightbox="example-1" data-title="Click the right half of the image to move forward."><img id="myImg" style="width:50px; height:70px;" class='example-image' src="data:image/png;base64, <?php echo $image_2; ?>"/></a></td>
                       ...
                       <td>
                        ...
                        <?php
                         ...
                         ?> 
                       <td>
                        <a href='advertisement.php?action=Reject_free_advertisement&id=<?php echo $id; ?>'><button type="button" class="btn btn-danger">Reject</button></a> 
                       </td>
                       <!--<td>
