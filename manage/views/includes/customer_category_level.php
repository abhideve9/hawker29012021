...
$adminName=$_SESSION['adminName'];
  if(isset($_REQUEST['submit']))
  {
    ...
    $updateQuery="UPDATE $type SET check_level_customer='$level',modified_date='$now',modified_user_name='$adminName',admin_status='1'";
    $updateResult=mysqli_query($db,$updateQuery);
      if($updateResult)
      {
        ...
        <script>
          ...
          location.href="level.php?action=category_level_for_customer";
        </script>
        <?php       
      }
      else{
