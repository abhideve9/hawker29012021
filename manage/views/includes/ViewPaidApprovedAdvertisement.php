  ...
  <!-- page content -->
       <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Paid Advertisement <b>(Approved Advertisements)</b></h2>
        ...
        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap " cellspacing="0" width="100%">
                      ...
                      <tbody>
                       <?php 
                $getUsers="SELECT * FROM paid_advertisement_by_merchant where payment_status='Paid' AND ads_status='Ongoing' AND aproval_status='1'";
                        ...
                        ' data-toggle='tooltip' data-placement='top' class='btn menu-icon  vd_bd-grey vd_grey' name='edit_free_advertisement' href='advertisement.php?action=edit_paid_advertisement1&id=<?php echo $id; ?>'> <i class='fa fa-pencil'></i> </a>
                       </td>
                       <?php 
