                    ...
                    <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                      ...
                      <div class="item form-group">
                       ...
                       <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea  rows="5" cols="100" required placeholder="Enter Detail of Advertisement" name="detail_of_advertisement" required="required" class="  form-control col-md-7 col-xs-12 " >
                        <?php echo $userRow['detail_of_advertisement']; ?></textarea>
                        </div>
                        </div>
