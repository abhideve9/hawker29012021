                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                          <?php 
                          $getUsers="SELECT * FROM check_version_for_customer";
                        ...
                        <td>
                            <a href="version.php?action=change_customer_version&id=<?php echo $id; ?>" class="btn menu-icon  vd_bd-grey vd_grey"><i class="fa fa-pencil"></i> Edit </a>
                          </td>
                        </tr>
                      <?php}?>   
                      </tbody>
