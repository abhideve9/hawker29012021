...
$id=$_GET['id'];
  ...
  $updateQuery="UPDATE paid_advertisement_by_merchant SET rejection_status='1',reason_of_reject='$reason_of_reject',modified_user_name='$adminName' where id='$id'";
    ...
    ?>
    <script>
      alert("Paid Advertisement Reject successfully");
...
<div class="vd_title-section clearfix">
  <div class="row">
    <div class="vd_panel-header col-sm-4">
      <h2>Rejection of Paid Advertisement</h2>
    </div>
  </div>
</div>
