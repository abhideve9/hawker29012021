        ...
        <div class="container ">
          ...
          <div class="vd_panel-header">
          	...
          	<div class="logo">
            	...
            	<a href="index.php" style="text-decoration:none;margin-top:-8px;">
				<!--<img alt="logo" src="img/viyanta-logo.png" width="120">--><h1>Hawker</h1></a>
            ...
            <div class="col-sm-8">
              ...
              <ul class="mega-ul">
                      ...
                      <li id="top-menu-1" class="one-icon mega-li"> 
                        <a href="../" target="_blank"><button type="button" class="btn vd_btn vd_bg-green">Visit Website<i class="fa fa-globe prepend-icon"></i> </button>  </a>     
                      </li>             
                    </ul>
                  </div>
                  </div>
                      ...
                      <li id="top-menu-profile" class="profile mega-li"> 
                          ...
                          <a href="#" class="mega-link"  data-action="click-trigger"> 
                              ...
                              <span  class="mega-image">
                                  ...
                                  <img src="img/avatar/avatar-2.jpg" alt="Admin" />               
