...
<html lang="en">
  ...
  <body class="nav-md">
   ...
   <?php 
    ...
    {
        $link = $_GET['action'];
        if ($link === 'categorylevel') 
        {
            include 'views/includes/categorylevel.php';
        }
        else if($link==='ActiveHawkerType')
        {
          include 'views/includes/activehawkertype.php';
        }
         else if($link==='category_level_for_customer')
        {
          include 'views/includes/customer_category_level.php';
        }
